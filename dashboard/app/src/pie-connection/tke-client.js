...
export class KnowledgeBase {
  ...
  async registerKnowledgeInteraction(type, graphPattern, argumentGraphPattern, resultGraphPattern, handler, prefixes) {
    let body = {
    ...
    let knowledgeInteractionId = (await response.json()).knowledgeInteractionId;
    ...
    if (handler != undefined && (type == 'AnswerKnowledgeInteraction' || type == 'ReactKnowledgeInteraction')) {
      ...
      return async (bindingSet) => {
        ...
        if (type == 'AskKnowledgeInteraction') {
          path = '/sc/ask';
        } else if (type == 'PostKnowledgeInteraction') {
          path = '/sc/post';
        }
        let response = await fetch(
  ...
  async registerAskKnowledgeInteraction(graphPattern, prefixes = {}) {
    return await this.registerKnowledgeInteraction('AskKnowledgeInteraction', graphPattern, undefined, undefined, undefined, prefixes);
  }

  async registerAnswerKnowledgeInteraction(graphPattern, handler, prefixes = {}) {
    return await this.registerKnowledgeInteraction('AnswerKnowledgeInteraction', graphPattern, undefined, undefined, handler, prefixes);
  }

  async registerPostKnowledgeInteraction(argumentGraphPattern, resultGraphPattern, prefixes = {}) {
    return await this.registerKnowledgeInteraction('PostKnowledgeInteraction', undefined, argumentGraphPattern, resultGraphPattern, undefined, prefixes);
  }

  async registerReactKnowledgeInteraction(argumentGraphPattern, resultGraphPattern, handler, prefixes = {}) {
    return await this.registerKnowledgeInteraction('ReactKnowledgeInteraction', undefined, argumentGraphPattern, resultGraphPattern, handler, prefixes);
  }
